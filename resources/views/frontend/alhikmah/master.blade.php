...
@section('title', 'ALHIKMAH UNIVERSITY')
@section('content')
...
<div class="custom-cursor__cursor-two"></div> --}}
    ...
    <div class="page-wrapper">
        @include('frontend.includes.alhikmah_header')
                    ...
                    <div class="col-xl-5">
                        <div class="about-two__left">
                            <div class="about-two__img wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                                <img src="{{asset('eup/images/resources/about-one-1.jpg')}}" alt="">
                                ...
                                <div class="blog-one__single">
                                    <div class="blog-one__img">
                                        ...
                                        <div class="blog-one__date">
                                            <span>
                                                {{ Carbon\Carbon::parse($blog->created_at)->isoFormat('MMM DD YY') }}</span>
                                            {{-- <p>Aug</p> --}}
                                        </div>
                                    </div>
                                    <div class="blog-one__content">
                                        <ul class="blog-one__meta list-unstyled">
                                            <li>
                                                <a href="{{ route('funnb.single.news', $blog->slug) }}"><i
                                                        class="fas fa-user-circle"></i>Admin</a>
                                            </li>
                                            {{-- <li>
                <a href="{{route('funnb.single.news',$blog->slug)}}"><i class="fas fa-comments"></i>2 Comments</a>
            </li> --}}
                                        </ul>
                                        <h3 class="blog-one__title">
                                            <a href="{{ route('funnb.single.news', $blog->slug) }}">
                                                {{ $blog->title }}
                                            </a>
                                        </h3>
                                    </div>

                                ...
                                <div class="card d-flex flex-row mb-3">
                                    <a class="d-flex card-img newsViewTab" data-id="{{ $newslist->id }}" href="#!">
                                        <img src="{{ asset('assets/images/news') }}/{{ $newslist->image }}"
                                            alt=""
                                            class="list-thumbnail responsive border-0" style="width:18rem; height:18rem">
                                    ...
                                    <div class="d-flex flex-grow-1 min-width-zero card-content">
                                        ...
                                        <div class="list-actions">
                                            ...
                                            <a href="{{ route('alhikmah.news.edit', $newslist->id) }}"><i
                                            ...
                                            <a
                                                href="https://twitter.com/intent/tweet?text=Default+share+text&url={{ config('app.url') }}/news/{{ $newslist->slug }}"><i
                                                    class="ik ik-twitter"></i></a>

                        ...
                        @foreach ($medias as $media)
                            <div class="col-xl-4 col-lg-4 col-12 col-sm-6 mb-4 list-item list-item-grid">
                                <div class="card d-flex flex-row mb-3">
                                    <a class="d-flex card-img newsViewTab" data-id="{{ $media->id }}" href="#!">
                                        {{-- @if (!empty($media->cover_img))
<img src="{{ asset('eup/media/') }}/{{ $media->cover_img }}" alt=""
class="list-thumbnail responsive border-0" style="width: 50%; height:150px">
@else
<img src="{{ asset('eup/media/placeholder.jpeg') }}" alt="">
@endif --}}
                                        @php
                                    ...
                                    <div class="d-flex flex-grow-1 min-width-zero card-content">
                                        ...
                                        <div class="list-actions">
                                            <a href="#!"><i class="ik ik-eye newsViewTab"
                                                    data-id="{{ $media->id }}"></i></a>
                                            <a href="{{ route('media.edit', $media->id) }}"><i class="ik ik-edit-2"></i>
                                            </a>
                                            @if (!empty($media->video_link))
                                                <a href="{{ $media->video_link }}"><i class="fa fa-video"></i>
                                                </a>
                                            @endif

                                            @if (!empty($media->mediafile))
                                                <a href="{{ $media->mediafile }}"><i class="fa fa-download"></i>
                                                </a>
                                            @endif

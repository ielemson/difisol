                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="partner" class="form-control" required>
                                            ...
                                            @foreach ($partners as $partner)
                                                <option value="{{strtolower($partner->header)}}" {{strtolower($partner->header) == $gallery->partner ?'selected':''}}>{{$partner->header}}</option> 
                                            @endforeach
                                ...
                                <div class="col-sm-12 col-lg-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" value=" {{$gallery->title}}" class="form-control @error('title') is-invalid @enderror" name="title" />
                                       </input>
                                        <div class="help-block with-errors"></div>

    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h5 class="mb-4">{{ __('Partner Card')}}</h5>
                <div class="row">
                   @if (count($services) > 0)
                       ...
                       <div class="col-xs-6 col-lg-3 col-12">
                        <div class="card">
                            <div class="position-relative">
                                <img class="card-img-top" src="{{asset('assets/images/partners')}}/{{$service->image}}" alt="partners">
                                @if ($service->status == 1)
                                <span
                            ...
                            <div class="card-body">
                                ...
                                <footer>
                                    ...
                                    <a href="{{ route('partner.edit', $service->id) }}">
                                        <i

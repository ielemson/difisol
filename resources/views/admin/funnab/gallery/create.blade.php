                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            <div class="row">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select name="partner" class="form-control" required>
                                            ...
                                            @foreach ($partners as $partner)
                                                <option value="{{strtolower($partner->header)}}" {{ $partner->header == "FUNNAB" ? "selected" : "disabled" }}>{{$partner->header}}</option> 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{ __('Gallery Image')}}<span class="text-red">*</span></label>
                                ...
                                <div class="col-sm-12 col-lg-12 col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="" type="text" class="form-control html-editor @error('title') is-invalid @enderror" name="title" />
                                        <div class="help-block with-errors"></div>
